...
export interface RepeatableZKPTestInterface extends utils.Interface {
  functions: {
    "SBT()": FunctionFragment;
    "isVerified(address)": FunctionFragment;
    "submitZKP(uint256[2],uint256[2][2],uint256[2],uint256[])": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "submitZKP", data: BytesLike): Result;
...
export interface RepeatableZKPTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RepeatableZKPTestInterface;
