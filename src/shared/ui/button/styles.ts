...
export const baseCls = tw`cursor-pointer relative text-[1rem] font-publicoTextMono tracking-[-0.02em] px-[1.55rem] h-[2.5rem] flex items-center justify-center rounded-[0.3rem]`;
