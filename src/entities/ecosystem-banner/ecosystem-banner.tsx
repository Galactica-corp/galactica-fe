  ...
  return (
    <div
      className="
        ...
        to-sandyBrown px-[3.125rem] py-10 text-white
      "
    >
      <div
        className="absolute left-0 top-0 z-0 size-full bg-contain bg-right-top bg-no-repeat"
        style={{
          backgroundImage: `url(${bannerBgUrl})`,
        }}
      ></div>
      <div className="relative z-10 max-w-[43rem]">
        <h2 className="mb-4 text-[1.875rem]">Explore Galactica Network</h2>
