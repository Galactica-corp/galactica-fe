    ...
    <Layout>
      <div className="grid grid-cols-2 gap-[2.18rem]">
        ...
        >
          <div className="font-light">
            <p className="mb-[0.7rem]">
              ...
              provider.
              <br /> Upload your KYC-key to verify your Metamask and activate
              your Galactica Passport.
            </p>
          </div>
        </HelpCard>
        <HelpCard
        ...
        >
          <div className="font-light">
            <p className="mb-[0.7rem]">
              To complete the KYC procedure, you need to Generate transaction
              for activating your Galactica zkProof and publish it to Metamask.
              After that, you will have access to all the features supported by
              your KYC level.
            </p>
          </div>
        </HelpCard>
